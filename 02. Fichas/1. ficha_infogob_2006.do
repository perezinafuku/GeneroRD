...
import delimited "`input_ficha'\resumen_2006.csv"

/*
id              long    %12.0g                
nombres         str35   %35s                  
apellido_pate~o str21   %21s                  
apellido_mate~o str43   %43s                  
dni             long    %12.0g                
sexo            str1    %9s                   
f_nacimiento    str10   %10s                  
cargo_postula~n str30   %30s                  
region_postul~n str13   %13s                  
provincia_pos~n str25   %25s                  
distrito_post~n str36   %36s                  
org_politica    str84   %84s                  
primaria_comp~a str5    %9s                   
secundaria_co~a str5    %9s                   
n_educacion_s~r byte    %8.0g                 
n_experiencia   byte    %8.0g                 
n_otra_experi~a byte    %8.0g                 
n_antecedentes  byte    %8.0g                 
...
replace cargo=. if cargo_postulacion=="CONSEJERO REGIONAL ACCESITARIO"
replace cargo=. if cargo_postulacion=="CONSEJERO REGIONAL TITULAR"
...
lab var n_educacion_superior "Tiene educacion superior"
lab var n_experiencia "Tiene experiencia laboral"
lab var n_otra_experiencia "Otra experiencia laboral"
lab var n_antecedentes "Antecedentes Judiciales y/o Penales"
...
save `middle_ficha'\fichas_2006, replace
