...
use "`middle_infogob'\hombremujer5_append", clear
gen id=_n
...
keep if _merge==3
mmerge iddistrito using "`middle_infogob'\hombremujer5_append"
...
save `middle_infogob'\hombremujer5_append_ubigeo, replace
