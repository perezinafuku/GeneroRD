...
import excel `input_ubigeo'\Excel\rptUbigeo-2014.xlsx,  ///
...
replace id3="HUAYLLO" if id3=="IHUAYLLO" & id1=="APURIMAC"
replace id3="HUALLA" if id3=="HUAYA" & id1=="AYACUCHO"
replace id3="ANDRES AVELINO CACERES" if id3=="ANDRES AVELINO CACERES DORREGARAY" & id1=="AYACUCHO"
*replace id3="SAN PEDRO DE LARAOS" if id3=="LARAOS" & id1=="LIMA" & id2=="HUAROCHIRI"
*replace id3="PAMPAS" if id3=="PAMPAS GRANDE" & id1=="ANCASH"

replace id2="MAYNAS" if id2=="PUTUMAYO" & id1=="LORETO" & id3=="PUTUMAYO"
replace id2="MAYNAS" if id2=="PUTUMAYO" & id1=="LORETO" & id3=="TENIENTE MANUEL CLAVERO"


egen iddistrito=concat(id1 id2 id3)

save `middle_ubigeo'\ubigeo_2014_v1, replace
