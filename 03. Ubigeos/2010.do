...
import excel `input_infogob'\Excel\rptUbigeo-2010.xlsx,  ///
...
replace id1 = subinstr(id1,"à","a",.)
replace id1 = subinstr(id1,"È","E",.)
replace id1 = subinstr(id1,"è","e",.)
replace id1 = subinstr(id1,"Ì","I",.)
replace id1 = subinstr(id1,"ì","i",.)
replace id1 = subinstr(id1,"Ò","O",.)
replace id1 = subinstr(id1,"ò","o",.)
replace id1 = subinstr(id1,"Ù","U",.)
replace id1 = subinstr(id1,"ù","u",.)
...
replace id2 = subinstr(id2,"à","a",.)
replace id2 = subinstr(id2,"È","E",.)
replace id2 = subinstr(id2,"è","e",.)
replace id2 = subinstr(id2,"Ì","I",.)
replace id2 = subinstr(id2,"ì","i",.)
replace id2 = subinstr(id2,"Ò","O",.)
replace id2 = subinstr(id2,"ò","o",.)
replace id2 = subinstr(id2,"Ù","U",.)
replace id2 = subinstr(id2,"ù","u",.)
...
replace id3 = subinstr(id3,"à","a",.)
replace id3 = subinstr(id3,"È","E",.)
replace id3 = subinstr(id3,"è","e",.)
replace id3 = subinstr(id3,"Ì","I",.)
replace id3 = subinstr(id3,"ì","i",.)
replace id3 = subinstr(id3,"Ò","O",.)
replace id3 = subinstr(id3,"ò","o",.)
replace id3 = subinstr(id3,"Ù","U",.)
replace id3 = subinstr(id3,"ù","u",.)
...
gen num=_n
save `middle_infogob'\ubigeo_2010, replace
